<template>
    <nav class="navbar navbar-expand-sm navbar-light bg-white mb-0">
        <router-link to="/" data-toggle="collapse" data-target=".navbar-collapse.show">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item mr-3" data-toggle="collapse" data-target=".navbar-collapse.show">
                    <router-link :to="{ name: 'lessons' }" tag="a" class="nav-link">уроки</router-link>
                </li>
                <li class="nav-item mr-3" data-toggle="collapse" data-target=".navbar-collapse.show">
                    <router-link :to="{ name: 'dictionary' }" tag="a" class="nav-link">словарь</router-link>
                </li>
                <li class="nav-item mr-3" data-toggle="collapse" data-target=".navbar-collapse.show">
                    <span @click="logout" class="nav-link">выход</span>
                </li>
                <li class="nav-item mr-3" data-toggle="collapse" data-target=".navbar-collapse.show">
                    <router-link :to="{ name: 'profile' }" tag="a" class="nav-link">профиль</router-link>
                </li>
...
<script>
    ...
    import { SERVlogout } from "../../server/server"
