...
<script>
    import { SERVgetLearningExamples } from "../../server/server"

    export default {
        name: "InternalExamplesComponent",
        props: ['scheme_id', 'scheme_url'],
        data() {
            return {
                example_index: 0,
                snd: undefined,
        ...
        methods: {
            ...
            fetch_data() {
                let reqLearningExamples = {
                    id_example: this.scheme_id
                }
                SERVgetLearningExamples(reqLearningExamples, (res) => {
                    this.examples = res.data['sentences']
                })
            }
        },
        created() {
